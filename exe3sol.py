...
# Chitchat
# Now you're going to leave the simple EchoBot behind and create a bot which can answer simple questions
# such as "What's your name?" and "What's today's weather?"
...
# Define a respond() function which takes in a message argument, checks if the message has a pre-defined response,
# and returns the response in the responses dictionary if there is a match, or the "default" message otherwise.
